...
class ImageProcessingApp:
    ...
    def setup_ui(self):
        ...
        # Input section
        input_section = tk.LabelFrame(control_frame, text="📁 INPUT GAMBAR", 
        ...
        # Processing section
        # Histogram 
        process_section = tk.LabelFrame(control_frame, text="⚙️ PROSES GAMBAR", 
                                       font=('Arial', 12, 'bold'), fg='#ecf0f1', bg='#34495e')
        ...
        arith_section = tk.LabelFrame(control_frame, text="➕ OPERASI ARITMATIKA", 
                                     font=('Arial', 12, 'bold'), fg='#ecf0f1', bg='#34495e')
        ...
        # Logic operations
        logic_section = tk.LabelFrame(control_frame, text="🔧 OPERASI LOGIKA", 
                                     font=('Arial', 12, 'bold'), fg='#ecf0f1', bg='#34495e')
        ...
        # Convolution section
        conv_section = tk.LabelFrame(control_frame, text="🔍 KONVOLUSI & FILTER", 
                                    font=('Arial', 12, 'bold'), fg='#ecf0f1', bg='#34495e')
        ...
        # Save section
        save_section = tk.LabelFrame(control_frame, text="💾 SIMPAN", 
                                    font=('Arial', 12, 'bold'), fg='#ecf0f1', bg='#34495e')
